...
class GroupedBorrowRequestCard extends StatefulWidget {
  ...
  @override
  State<GroupedBorrowRequestCard> createState() => _GroupedBorrowRequestCardState();
}
...
class _GroupedBorrowRequestCardState extends State<GroupedBorrowRequestCard> {
  ...
  int get _returnedCount => widget.requests.where((r) => r.isEquipmentReturned).length;
  ...
  bool get _isOverdue => widget.requests.any((r) => r.isOverdueByDate && !r.isEquipmentReturned);
  ...
  String get _statusText {
    ...
    if (_partiallyReturned) return 'Partially Returned ($_returnedCount/${widget.requests.length})';
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // Mark as Return Button (only if not all returned)
                  if (!_allReturned)
                    TextButton.icon(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(
              ...
              size: 20,
              color: request.isEquipmentReturned ? Colors.green : AppColors.primaryBlue,
            ),
          ),
          const SizedBox(width: 12),
